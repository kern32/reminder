	...
	<div class="container">
		<div class="login-form">
			...
			<form action="${pageContext.request.contextPath}/app/registration.html" method="POST" id="login-form">
				...
				<input type="text"	name="req_email" id="req_email" class="form-control" placeholder="username@example.com"
				onchange="if(this.value != '') callAjax(this.id, this.value);"> 
					<p id="existing_email"></p>
				
				<input type="text" name="req_phone" id="phone" class="form-control" placeholder="+38 (097) 999-9999" > 
				<input type="text" name="req_skype" id="req_skype" class="form-control" placeholder="Skype name" > 
				<input type="password" name="req_psw" id="req_psw" class="form-control" placeholder="Password" > 
				<input type="password" name="req_confirmPsw" id="req_confirmPsw"  class="form-control" placeholder="Confirm password" >
				<button type="submit" class="btn btn-primary btn-block">Create account</button>
			</form>
			<div class="col-xs-6 col-md-4">
				<a class="btn btn-link small" href="./login.html" style="margin-left: 85px; margin-top: 15px">Log in</a>
			</div>
		</div>
	</div>
